...
public:
	...
	static void OrderNextMove(const ThreadId threadId, const SearchState& state, const Ply ply, const MoveCount currentIndex, MoveArray& moves, ScoreArray& seeScores, MoveScoreArray& staticScores, const MoveCount moveCount, const Board& board);
};
